...
<?php endif; ?>
            ...
            <!-- <div class="hidden sm:flex sm:items-center">
                <?php if(auth()->guard()->check()): ?>
                    <div class="text-gray-500 hover:text-gray-700"><?php echo e(Auth::user()->name); ?></div>
        ...
        <!-- <div x-show="open" class="sm:hidden">
            <div class="space-y-1">
                <a href="<?php echo e(route('dashboard')); ?>"
                    class="<?php echo e(request()->routeIs('dashboard') ? 'border-indigo-400 text-gray-900 focus:border-indigo-700' : 'border-transparent hover:border-gray-300 focus:text-gray-700 focus:border-gray-300'); ?> block px-4 py-2 text-gray-700 hover:bg-gray-100">
                    <?php echo e(__('Dashboard')); ?>
            ...
            <?php if(auth()->guard()->check()): ?>
                <div class="border-t border-gray-200">
                    <div class="px-4 py-2 text-gray-500"><?php echo e(Auth::user()->name); ?></div>
                    <a href="<?php echo e(route('logout')); ?>"
...
<div class="bg-blue-500">
	<nav class="relative px-4 py-4 flex justify-between items-center bg-white">
		...
		<ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
			<li><a class="text-sm text-gray-400 hover:text-gray-500" href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
    ...
    <!-- <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
        ...
        <div class="offcanvas-body flex flex-col"> -->
            ...
            <!-- <div>
                <ul>
                    <li class="mb-1">
                        <a class="block p-4 text-sm font-semibold hover:bg-blue-50 hover:text-blue-600 rounded <?php echo e(request()->routeIs('dashboard') ? 'bg-blue-50 text-blue-600' : 'text-gray-400'); ?>"  href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a>
                    </li>
                </ul>
            </div>
            <div class="mt-auto">
	...
	<div class="navbar-menu fixed inset-0 z-50 hidden bg-black bg-opacity-50 transition-all duration-300 opacity-0 translate-x-full"><!--navbar-menu relative z-50 hidden transition-all duration-300-->
		...
		<nav class="fixed top-0 right-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
			<div class="flex items-center mb-8">
				<a class="mr-auto text-3xl font-bold leading-none flex items-center" style="gap: 0.5rem;" href="<?php echo e(route('dashboard')); ?>">
			...
			<div>
				<ul>
					<li class="mb-1">
						<a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a>
					</li>
					<!-- <li class="mb-1">
...
<!--<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>--><?php /**PATH /var/www/chat.sxags.com/themes/tailwind/views/layouts/navigation.blade.php ENDPATH**/ ?>